...
export default function FacultyDiscussionsPage() {
    ...
    return (
        <div className="space-y-8">
            {/* Header */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-500 p-8 text-white">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-3xl font-bold">Classroom Discussions</h1>
                    </div>
                    <p className="text-white/80 max-w-xl">
                        Engage with students, answer questions, and moderate subject discussions in real-time.
                    </p>
                </div>
            ...
            {subjects.length === 0 ? (
                <Card className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground">You are not assigned to any subjects yet.</p>
                </Card>
            ) : (
                        ...
                        >
                            <Card className="group relative overflow-hidden hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-background to-muted/30">
                                ...
                                <CardContent className="p-6 relative">
                                    {/* Subject Code Badge */}
                                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-xs font-medium mb-4">
                                        {subject.code}
                                    </div>

                                    {/* Subject Name */}
                                    <h3 className="text-xl font-semibold mb-4 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                                        {subject.name}
                                    </h3>
